...
var $author$project$Main$emptyProgressBar = function (masteryWindow) {
	return A2($elm$core$List$repeat, masteryWindow, $elm$core$Maybe$Nothing);
};
var $author$project$Main$anotherDistractor = {correctAnswer: false, feedback: 'You chose the second distractor', textPart: 'This is the second distractor'};
var $author$project$Main$correctResponse = {correctAnswer: true, feedback: 'You chose the right answer', textPart: 'This is the right answer'};
var $author$project$Main$oneDistractor = {correctAnswer: false, feedback: 'You chose the first distractor', textPart: 'This is the first distractor'};
var $author$project$Main$emptyQuestion = {
	image: $elm$core$Maybe$Nothing,
	possibleResponses: _List_fromArray(
		[$author$project$Main$correctResponse, $author$project$Main$oneDistractor, $author$project$Main$anotherDistractor]),
	stem: 'This is an empty question'
};
var $author$project$Main$createNewModel = F2(
	function (newWindowDimensions, newMasterySettings) {
		return {
			currentQuestion: $author$project$Main$emptyQuestion,
			debug: false,
...
var $author$project$Main$getFromTorus = _Platform_incomingPort(
	'getFromTorus',
	A2(
		...
		A2($elm$json$Json$Decode$field, 'window', $elm$json$Json$Decode$int)));
...
var $author$project$Main$mySubscriptions = function (_v0) {
...
var $author$project$Main$addToProgressBar = F3(
	function (masterySettings, progressBar, progress) {
		return A2(
			...
			A2($elm$core$List$take, masterySettings.window - 1, progressBar));
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $elm$json$Json$Encode$bool = _Json_wrap;
var $author$project$Main$sendToTorus = _Platform_outgoingPort('sendToTorus', $elm$json$Json$Encode$bool);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'MsgWindowSizeChanged':
				var newWidth = msg.a;
				var newHeight = msg.b;
				var newWindowDimensions = {winHeight: newHeight, winWidth: newWidth};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{windowDimensions: newWindowDimensions}),
...
var $author$project$Main$viewDebugPanel = function (model) {
			...
			[
				...
				_List_fromArray(
					[
						...
						'threshold: ' + $elm$core$String$fromInt(model.masterySettings.threshold))
					])),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(
						'window: ' + $elm$core$String$fromInt(model.masterySettings.window))
					])),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(
						'window height: ' + $elm$core$String$fromInt(model.windowDimensions.winHeight))
					])),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(
						'window width: ' + $elm$core$String$fromInt(model.windowDimensions.winWidth))
					]))
...
var $author$project$Main$viewQuestionImage = function (questionImage) {
	if (questionImage.$ === 'Nothing') {
		return $mdgriffith$elm_ui$Element$none;
	} else {
		var imageType = questionImage.a;
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$initializeModel, subscriptions: $author$project$Main$mySubscriptions, update: $author$project$Main$updateModel, view: $author$project$Main$viewModel});
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'winWidth', $elm$json$Json$Decode$int)))(0)}});}(this));